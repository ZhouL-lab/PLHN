# Prototype Learning Guided Hybrid Network for Breast Tumor Segmentation in DCE-MRI accepted by Transaction on Medical Imaging ([paper](https://ieeexplore.ieee.org/document/10614219))
## Paper
