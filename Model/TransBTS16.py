...
class LearnedPositionalEncoding(nn.Module):
    def __init__(self, max_position_embeddings, embedding_dim, seq_length):
        ...
        self.position_embeddings = nn.Parameter(torch.zeros(1, 1024, 512)) #2048
...
class TransformerBTS(nn.Module):
    def __init__(
       ...
       # assert img_dim % patch_dim == 0
        ...
        self.Unet = UnetBackBone(in_channels= inchannel , base_channels=16, num_classes=num_class)
        self.bn = nn.BatchNorm3d(128) ##16,128,64
...
class BTS(TransformerBTS):
    ...
    def decode(self, x1_1, x2_1, x3_1, x, intmd_x, intmd_layers=[1, 2, 3, 4]):
        ...
        ################################################
        y4 =self.DeUp4(x8, x3_1)  # (1, 64, 32, 32, 32) self.DeUp4(x8, x3_1)
        y4 = self.DeBlock4(y4)
...
if __name__ == '__main__':
    with torch.no_grad():
        ...
        x = torch.rand((1, 2, 64, 128, 128), device=cuda0)
