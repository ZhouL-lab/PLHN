...
class FixedPositionalEncoding(nn.Module):
    def __init__(self, embedding_dim, max_length=256):
...
class LearnedPositionalEncoding(nn.Module):
    def __init__(self, max_position_embeddings, embedding_dim, seq_length):
        ...
        self.position_embeddings = nn.Parameter(torch.zeros(1, 1024, 256)) #2048
...
class TransformerBTS(nn.Module):
    def __init__(
       ...
       # assert img_dim % patch_dim == 0
        ...
        self.Unet = UnetBackBone(in_channels= inchannel , base_channels=8, num_classes=num_class)
        self.bn = nn.BatchNorm3d(64) ##16,128
    ...
    def encode(self, x):
        ...
        x, intmd_x = self.transformer(x) ##不加位置编码？
...
if __name__ == '__main__':
    ...
    with torch.no_grad():
        ...
        x = torch.rand((1, 2, 32, 128, 128), device=cuda0)
