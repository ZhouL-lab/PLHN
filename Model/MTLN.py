...
class MTLN3D(nn.Module):
    def __init__(self, out_dim,vis=False):
        ...
        self.predict_fuse0 = nn.Conv3d(64, out_dim, kernel_size=1)
        self.predict_fuse1 = nn.Conv3d(64, out_dim, kernel_size=1)

        self.predict = nn.Conv3d(64, out_dim, kernel_size=1)
    ...
    def forward(self, x):
        ...
        return nn.Sigmoid()(seg_fuse0), nn.Sigmoid()(seg_fuse1), nn.Sigmoid()(seg_predict)
