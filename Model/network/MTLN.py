...
from network.BackBone import BackBone3D
from network.BiVAblock import BiVA
...
class MTLN3D(nn.Module):
    def __init__(self, vis=False):
        ...
        #５类分割
        self.predict_fuse0 = nn.Conv3d(64, 5, kernel_size=1)
        self.predict_fuse1 = nn.Conv3d(64, 5, kernel_size=1)

        self.predict = nn.Conv3d(64, 5, kernel_size=1)
