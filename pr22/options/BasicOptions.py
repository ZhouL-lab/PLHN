...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--checkpoints_dir', type=str, default='./checkpoints_almn', help='models are saved here')
        ...
        parser.add_argument('--datapath', default = r'/data/shaofengzou/PanSTEEL/MIDATA/BREAST_data_520', help='path of the PET raw data')
        parser.add_argument('--lr', type=float, default=0.005, help='initial learning rate of net for adam') #0.005
