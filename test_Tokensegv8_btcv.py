...
import os
from dataset.dataset_lits_tests import Test_all_Datasets, Recompone_tool
...
def test_all(model_name='model_200.pth'):
    ...
    save_result_path = os.path.join(opt.checkpoints_dir, opt.task_name, 'Predynxx')
...
if __name__ == '__main__':
    test_all('TokenSegx8m_final_80.6.pth')
