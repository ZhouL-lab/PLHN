...
if __name__ == '__main__':
    ...
    if org == 1:  ##To save all the model.
        ...
        weightsp='/data/shaofengzou/PanSTEEL/MIDATA/PR_network/NET3/checkpoints_n2/runet_4/model/model_200.pth'
        ...
        backb_dict = torch.load(weightspaf)
